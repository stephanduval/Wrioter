...
import academyCertificateGirl from '@images/illustrations/academy-certificate-girl.png'
import academyCoursesGirl from '@images/illustrations/academy-courses-girl.png'
      ...
      <VRow>
        <VCol
          v-for="{ title, btnText, color, description, image } in [
            { title: 'Earn a Certificate', description: 'Get the right professional certificate program for you.', btnText: 'View Programs', color: 'primary', image: academyCertificateGirl },
            { title: 'Best Rated Courses', description: 'Enroll now in the most popular and best rated courses.', btnText: 'View Courses', color: 'error', image: academyCoursesGirl },
          ]"
          :key="title"
          cols="12"
          md="6"
        >
          ...
          >
            <VCardText>
              <div class="d-flex justify-space-between gap-6 align-center flex-column-reverse flex-sm-row">
