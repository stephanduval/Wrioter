...
const widgetData = ref([
  { title: 'Pending Payment', value: 56, icon: 'bx-calendar' },
  { title: 'Completed', value: 12689, icon: 'bx-check-double' },
  { title: 'Refunded', value: 124, icon: 'bx-wallet' },
  { title: 'Failed', value: 32, icon: 'bx-error-alt' },
])
      ...
      >
        ...
        <template #item.payment="{ item }">
          <div
            ...
            class="font-weight-medium d-flex align-center gap-x-1"
          >
            <VIcon
              icon="bx-bxs-circle"
              size="8"
