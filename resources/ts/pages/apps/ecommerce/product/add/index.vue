...
const inventoryTabsData = [
  { icon: 'bx-cube', title: 'Restock', value: 'Restock' },
  { icon: 'bx-car', title: 'Shipping', value: 'Shipping' },
  { icon: 'bx-globe', title: 'Global Delivery', value: 'Global Delivery' },
  { icon: 'bx-link', title: 'Attributes', value: 'Attributes' },
  { icon: 'bx-lock', title: 'Advanced', value: 'Advanced' },
]
</script>
      ...
      <VCol md="8">
        ...
        >
          <VCardText>
            <VRow>
              ...
              <VCol>
                <span class="text-body-1 d-inline-block">Description (optional)</span>
        ...
        <VCard class="mb-6">
          <VCardItem>
            ...
            <template #append>
              <span class="text-primary align-center text-h6 cursor-pointer">Add Media from URL</span>
            </template>
          </VCardItem>
                    ...
                    <div class="d-flex flex-column gap-y-4 ps-md-3">
                      ...
                      <div>
                        <div class="text-base text-high-emphasis pb-2">
                          Product in stock now: <span class="text-medium-emphasis">54</span>
                        </div>
                        <div class="text-base text-high-emphasis pb-2">
                          Product in transit: <span class="text-medium-emphasis">390</span>
                        </div>
                        <div class="text-base text-high-emphasis pb-2">
                          Last time restocked: <span class="text-medium-emphasis">24th June, 2022</span>
                        </div>
                        <div class="text-base text-high-emphasis pb-2">
                          Total stock over lifetime: <span class="text-medium-emphasis">2,340</span>
                        </div>
                      </div>
                    </div>
                  </VWindowItem>
