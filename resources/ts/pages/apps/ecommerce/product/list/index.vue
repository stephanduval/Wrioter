...
const resolveCategory = (category: string) => {
  if (category === 'Accessories')
    return { color: 'error', icon: 'bx-headphone' }
  if (category === 'Home Decor')
    return { color: 'info', icon: 'bx-home-smile' }
  if (category === 'Electronics')
    return { color: 'primary', icon: 'bx-laptop' }
  if (category === 'Shoes')
    return { color: 'success', icon: 'bx-walk' }
  if (category === 'Office')
    return { color: 'warning', icon: 'bx-briefcase' }
  if (category === 'Games')
    return { color: 'primary', icon: 'bx-game' }
}
