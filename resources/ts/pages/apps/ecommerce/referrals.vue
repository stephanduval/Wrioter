...
const widgetData = [
  { title: 'Total Earning', value: '$24,983', icon: 'bx-dollar', color: 'primary' },
  { title: 'Unpaid Earning', value: '$8,647', icon: 'bx-gift', color: 'success' },
  { title: 'Signup', value: '2,367', icon: 'bx-group', color: 'error' },
  { title: 'Conversion Rate', value: '4.5%', icon: 'bx-infinite', color: 'info' },
]

const stepsData = [
  { icon: 'bx-rocket', desc: 'Create & validate your referral link and get', value: '$50' },
  { icon: 'bx-bxs-user-badge', desc: 'For every new signup you get', value: '10%' },
  { icon: 'bx-paper-plane', desc: 'Get other friends to generate link and get', value: '$100' },
]
