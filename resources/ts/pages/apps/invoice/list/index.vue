...
const widgetData = ref([
  { title: 'Clients', value: 24, icon: 'bx-user' },
  { title: 'Invoices', value: 165, icon: 'bx-file' },
  { title: 'Paid', value: '$2.46k', icon: 'bx-check-double' },
...
const resolveInvoiceStatusVariantAndIcon = (status: string) => {
  ...
  if (status === 'Past Due')
    return { variant: 'error', icon: 'bx-help-circle' }
