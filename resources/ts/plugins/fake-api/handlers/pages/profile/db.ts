  ...
  data: {
    ...
    profile: {
      about: [
        ...
        { property: 'Role', value: 'Developer', icon: 'bx-crown' },
      ...
      teams: [
        { property: 'Backend Developer', value: '(126 Members)', icon: 'bx-bxl-github', color: 'secondary' },
        { property: 'VueJS Developer', value: '(98 Members)', icon: 'bx-bxl-vuejs', color: 'success' },
      ],
      overview: [
