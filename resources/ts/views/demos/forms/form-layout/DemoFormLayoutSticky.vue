...
const radioContent: CustomInputContent[] = [
  {
    ...
    value: 'standard',
    icon: { icon: 'bx-briefcase', size: '32' },
  },
  {
    title: 'Express',
    desc: 'Delivery within 2 days.',
    value: 'express',
    icon: { icon: 'bx-rocket', size: '32' },
  },
  {
    title: 'Overnight',
    desc: 'Delivery within a days.',
    value: 'overnight',
    icon: { icon: 'bx-crown', size: '32' },
  },
]
...
<template>
  <VCard class="overflow-visible">
    <div class="w-100 sticky-header overflow-hidden rounded-t">
      <div class=" d-flex align-center gap-4 justify-space-between flex-wrap bg-custom-background border-b pa-6">
        <h5 class="text-h5">
          Sticky Action Bar
        </h5>
        <div>
