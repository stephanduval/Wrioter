          ...
          >
            <div class="contact-card h-100">
              <VCard
                ...
                border
                class="pa-2"
                style=" border-end-end-radius: 0.375rem; border-end-start-radius: 0.375rem; border-start-end-radius: 0.375rem;
              ...
              >
                ...
                <VCardText class="pa-4 pb-1">
                  <div class="d-flex justify-space-between flex-wrap gap-y-4">
                    <div
                      v-for="(item, index) in [
                        { title: 'Email', icon: 'bx-envelope', color: 'primary', value: 'example@gmail.com' },
                        { title: 'Phone', icon: 'bx-phone-call', color: 'success', value: '+1234 568 963' },
                      ]"
                      :key="index"
