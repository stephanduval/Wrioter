...
const reviewData = [
  {
    desc: 'I\'ve never used a theme as versatile and flexible as Sneat. It\'s my go to for building dashboard sites on almost any project.',
    img: logo1,
    rating: 5,
    name: 'Eugenia Moore',
  ...
  {
    desc: 'Sneat is awesome, and I particularly enjoy knowing that if I get stuck on something, there is always a helpful community to assist me.',
    img: logo3,
    rating: 5,
    name: 'Tommy haffman',
