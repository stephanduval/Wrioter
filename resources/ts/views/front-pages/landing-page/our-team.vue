...
const teamData = ref([
  { name: 'Sophie Gilbert', position: 'Project Manager', image: teamPerson1, backgroundColor: 'rgba(105, 108, 255, 0.16)', borderColor: 'rgba(105, 108, 255, 0.16)', isHover: false },
  { name: 'Paul Miles', position: 'UI Designer', image: teamPerson2, backgroundColor: 'rgba(3, 195, 236, 0.16)', borderColor: 'rgba(3, 195, 236, 0.16)', isHover: false },
  { name: 'Nannie Ford', position: 'Development Lead', image: teamPerson3, backgroundColor: 'rgba(255, 62, 29, 0.16)', borderColor: 'rgba(255, 62, 29, 0.16)', isHover: false },
  { name: 'Chris Watkins', position: 'Marketing Manager', image: teamPerson4, backgroundColor: 'rgba(113, 221, 55, 0.16)', borderColor: 'rgba(113, 221, 55, 0.16)', isHover: false },
])
</script>
