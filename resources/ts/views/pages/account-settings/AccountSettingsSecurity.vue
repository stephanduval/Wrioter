...
const recentDevices = [
  {
    ...
    deviceIcon: { icon: 'bx-bxl-windows', color: 'info' },
  },
  {
  ...
  },
  {
    ...
    deviceIcon: { icon: 'bx-bxl-android', color: 'success' },
  },
  {
    ...
    location: 'New York, NY',
    recentActivity: '28 Apr 2022, 18:20',
    deviceIcon: { icon: 'bx-bxl-apple', color: 'warning' },
  },
  {
    browser: 'Chrome on Windows',
    device: 'HP Spectre 360',
      ...
      <VCard title="Create an API key">
        <VRow no-gutters>
          ...
          >
            <VImg
              :src="laptopGirl"
              :width="$vuetify.display.smAndDown ? '230' : '300'"
