...
const vehicleData = [
  { icon: 'bx-car', title: 'On the way', time: '2hr 10min', percentage: 39.7 },
  { icon: 'bx-up-arrow-circle', title: 'Unloading', time: '3hr 15min', percentage: 28.3 },
  { icon: 'bx-down-arrow-circle', title: 'Loading', time: '1hr 24min', percentage: 17.4 },
  { icon: 'bx-time-five', title: 'Waiting', time: '5hr 19min', percentage: 14.6 },
]
    ...
    <VCardText>
      <div class="d-flex mb-6">
        <div style="inline-size: 39.7%;">
          ...
          >
            <div class="text-start text-sm text-high-emphasis font-weight-medium">
              39.7%
            </div>
          </VProgressLinear>
        </div>
