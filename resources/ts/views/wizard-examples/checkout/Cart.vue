        ...
        >
          ...
          >
            ...
            <div class="d-flex w-100 flex-column flex-md-row">
              ...
              <div
                class="d-flex flex-column mt-6 text-start text-md-end"
        ...
        <VCardText>
          ...
          <div class="text-high-emphasis">
            <div class="d-flex justify-space-between mb-2">
              <span>Bag Total</span>
              <span class="text-high-emphasis">${{ totalCost }}.00</span>
            </div>
...
.checkout-rating {
  .v-rating__item {
    .v-btn {
      --v-btn-height: 1.25rem !important;
      --v-btn-width: 1.25rem !important;
    }
  }
}
</style>
