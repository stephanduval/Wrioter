      ...
      >
        <VCardText>
          ...
          <div class="d-flex justify-space-between text-base mb-2">
            ...
            <span class="text-high-emphasis">${{ checkoutPaymentDataLocal.orderAmount }}.00</span>
          </div>
          ...
          <div class="d-flex justify-space-between text-base">
            ...
            <div v-else>
              <span class="text-high-emphasis">${{ checkoutPaymentDataLocal.deliveryCharges }}</span>
            </div>
          </div>
        </VCardText>
        ...
        <VCardText>
          <div class="d-flex justify-space-between text-base mb-2">
            ...
            <span class="text-high-emphasis font-weight-medium">${{ checkoutPaymentDataLocal.orderAmount + checkoutPaymentDataLocal.deliveryCharges }}.00</span>
          </div>

          <div class="d-flex justify-space-between text-base mb-4 align-center">
